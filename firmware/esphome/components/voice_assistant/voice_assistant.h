...
class VoiceAssistant : public Component {
 ...
 protected:
  ...
  void signal_stop_();
  // CS-159 fork addition (see FORK_NOTES.md). Returns false when the message
  // could not be handed to the API client, so the caller can fail visibly.
  bool signal_finish_();
...
// CS-159 fork addition: graceful end-of-speech action (see FORK_NOTES.md).
