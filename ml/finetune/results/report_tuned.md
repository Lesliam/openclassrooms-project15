# Coach FR baseline evaluation report - transformers-coach-tuned-v0

- Mode: `baseline`
- Model under test: `coach-tuned:v0`
...
- D1 deterministic pre-check compliance (4-part marker PRESENCE + brevity; part ORDER and the 'exactly one explanation sentence' rule are NOT verified here - judge pending): 95.0%
- D1 false-positive rate (error-free turns wrongly corrected): 12.5%
- D2 French-persistence rate: 100.0%
- D2 mean French-token fraction: 1.000
...
| 15 | D2 | 100.0% | 100.0% | +0.0pp |
| 15 | brevity | 100.0% | 100.0% | +0.0pp |
| 16 | brevity | 50.0% | 100.0% | -50.0pp |
